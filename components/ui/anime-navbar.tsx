  ...
  return (
    <div className="fixed top-5 left-0 right-0 z-[9999] pointer-events-none">
      <div className="flex justify-center pt-6 pointer-events-auto">
        <motion.div 
          className="flex items-center gap-3 bg-background/80 border border-border backdrop-blur-lg py-2 px-2 rounded-full shadow-lg relative"
                ...
                {isActive && (
                  ...
                  >
                    <div className="relative w-12 h-12">
                      <motion.div 
                        className="absolute w-10 h-10 bg-card rounded-full left-1/2 -translate-x-1/2 border border-border"
                        animate={
                          hoveredTab ? {
                            scale: [1, 1.1, 1],
                            rotate: [0, -5, 5, 0],
                      ...
                      >
                        ...
                        <motion.div 
                          className="absolute w-4 h-2 border-b-2 border-foreground rounded-full"
                          animate={
                            hoveredTab ? {
                              scaleY: 1.5,
                              y: -1
                      ...
                      >
                        <div className="w-full h-full bg-card rotate-45 transform origin-center border border-border" />
                      </motion.div>
                    </div>
                  </motion.div>
                )}
